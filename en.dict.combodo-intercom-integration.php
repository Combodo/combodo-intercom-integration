...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:UserRequest/Attribute:intercom_sync_activated' => 'Intercom sync. activated?',
	'Class:UserRequest/Attribute:intercom_sync_activated+' => 'Whether the logs synchronization from Intercom is activated. If set to \'Yes\', new messages on the Intercom conversation will automatically be added here.',
	'Class:UserRequest/Attribute:intercom_sync_activated/Value:yes' => 'Yes',
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'combodo-intercom-integration:SyncApp:SubmitButton:Title' => 'Submit',
	'combodo-intercom-integration:SyncApp:CreateButton:Title' => 'Create',
	'combodo-intercom-integration:SyncApp:PauseLinkedTicketsSync:Title' => 'Pause linked ticket(s) sync.',
	'combodo-intercom-integration:SyncApp:ResumeLinkedTicketsSync:Title' => 'Resume linked ticket(s) sync.',
	...
	'combodo-intercom-integration:SyncApp:HomeCanvas:LinkedTicketsExplanation:Title' => 'Linked tickets',
	'combodo-intercom-integration:SyncApp:HomeCanvas:LinkedTicketsExplanation:Text:NoTicketLinked' => 'To link a ticket to this conversation, either choose one of the ongoing tickets or create a new one.',
	'combodo-intercom-integration:SyncApp:HomeCanvas:LinkedTicketsExplanation:Text:SyncActive' => 'Synchronization is active, new messages (both replies and notes) will be added to the linked ticket(s).',
	'combodo-intercom-integration:SyncApp:HomeCanvas:LinkedTicketsExplanation:Text:SyncInactive' => 'Synchronization is paused, new messages (both replies and notes) will NOT be added to the linked ticket(s).',
	'combodo-intercom-integration:SyncApp:HomeCanvas:LinkedTicketsExplanation:Text:SyncPartial' => 'Only %1$s ticket(s) synced. Click the \'Resume\' button to set all linked tickets as synced.',
